...
![React](https://img.shields.io/badge/React-18%2B-61DAFB?style=flat&logo=react&logoColor=black)
...
Runs on 127.0.0.1 only — no cloud dependency, no telemetry, no account, 
no external data pipeline.
